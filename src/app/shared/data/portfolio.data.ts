  ...
  de: {
      ...
      items: [
        {
          ...
          liveUrl: 'https://ahmad-ataya.de/join/',
        ...
        },
        {
          ...
          liveUrl: 'https://ahmad-ataya.de/el-pollo-loco/',
    ...
    testimonials: {
      ...
      items: [
        {
          quote:
            'Ahmad arbeitet zuverlässig, strukturiert und lösungsorientiert. Auch bei komplexen Aufgaben behält er den Überblick und unterstützt das Team mit klarer Kommunikation.',
          author: 'Christian W.',
          role: 'Teamkollege · Join',
        },
        {
          quote:
            'Die Zusammenarbeit mit Ahmad ist angenehm und produktiv. Er bringt eigene Ideen ein, übernimmt Verantwortung und arbeitet konsequent an einer sauberen Umsetzung.',
          author: 'Daniel K.',
          role: 'Teamkollege · Join',
        },
        {
          quote:
            'Ahmad ist engagiert, hilfsbereit und lernt neue Technologien sehr schnell. Seine positive Art und sein Qualitätsanspruch machen ihn zu einem starken Teamkollegen.',
          author: 'Salih D.',
          role: 'Kurskollege · Webentwicklung',
        },
      ],
    },
    contact: {
      ...
      nameLengthError: 'Dein Name muss mindestens drei Zeichen lang sein.',
      nameFormatError: 'Bitte verwende nur Buchstaben, Leerzeichen, Bindestriche oder Apostrophe.',
      ...
      messageRequiredError: 'Bitte gib eine Nachricht ein.',
      messageLengthError: 'Deine Nachricht muss mindestens zehn Zeichen lang sein.',
      ...
      readyMessage: 'Vielen Dank! Deine Nachricht wurde erfolgreich gesendet.',
      sendErrorMessage: 'Die Nachricht konnte nicht gesendet werden. Bitte versuche es später erneut.',
    },
    footer: {
      role: 'Webentwickler',
  ...
  en: {
    ...
    testimonials: {
      ...
      items: [
        {
          quote:
            'Ahmad works reliably, methodically and with a strong focus on solutions. Even with complex tasks, he keeps an overview and supports the team through clear communication.',
          author: 'Christian W.',
          role: 'Teammate · Join',
        },
        {
          quote:
            'Working with Ahmad is both pleasant and productive. He contributes his own ideas, takes responsibility and consistently aims for a clean implementation.',
          author: 'Daniel K.',
          role: 'Teammate · Join',
        },
        {
          quote:
            'Ahmad is committed, helpful and quick to learn new technologies. His positive attitude and focus on quality make him a strong teammate.',
          author: 'Salih D.',
          role: 'Course colleague · Web development',
        },
      ],
    },
    contact: {
      ...
      nameLengthError: 'Your name must be at least three characters long.',
      nameFormatError: 'Please use only letters, spaces, hyphens, or apostrophes.',
      ...
      messageLengthError: 'Your message must be at least ten characters long.',
      ...
      readyMessage: 'Thank you! Your message was sent successfully.',
      sendErrorMessage: 'Your message could not be sent. Please try again later.',
    },
    footer: {
      role: 'Web Developer',
